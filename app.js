...
function App() {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", height: "100vh", fontFamily: T.font, overflowX: "clip", overflowY: "hidden" }}>
      ...
      {/* Header banner */}
      <div style={{ background: "#fff", borderBottom: "1px solid #DFDFE8", padding: "20px 28px", flexShrink: 0 }}>
        <div style={{ marginBottom: 12 }}>
          <svg width="148" height="54" viewBox="0 0 591 217" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div style={{ fontFamily: T.font, fontSize: 22, fontWeight: 700, lineHeight: "28px", color: T.textPri, marginBottom: 6 }}>Mockup Tool</div>
        <div style={{ fontFamily: T.font, fontSize: 14, lineHeight: "20px", color: T.textSec, maxWidth: 620 }}>
          Upload your hero image, challenge badge, and brand logo using the panel on the left. Customise the text fields to match your challenge, then select a screen type to preview. Hit "Download PNG" to export.
        </div>
      </div>
