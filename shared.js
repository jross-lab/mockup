...
function PhoneShell({ children, screenRef, bgColor }) {
  ...
  return (
    <div style={{ position: "relative", width: 375, borderRadius: 50, background: frameColor, padding: 8, flexShrink: 0 }}>
      <div ref={screenRef} style={{ borderRadius: 42, overflow: "hidden", background: T.bgSunken, position: "relative" }}>
