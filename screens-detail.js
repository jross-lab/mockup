...
// Based on Figma node 2179:30719. A cleaner detail page with
// hero → overlay card (badge, title, description, CTA) → details → organizer.
function ScreenChallengeDetails({ data }) {
  const { heroImg, badgeImg, logoImg, brandName, title, goal, description, participants,
          startDate, endDate, activityType, reward } = data;
  return (
    <div style={{ display: "flex", flexDirection: "column", background: "#000", position: "relative" }}>
      ...
      {/* ── Cover Image (282px tall per Figma) ── */}
      <div style={{ width: "100%", height: 282, overflow: "hidden", flexShrink: 0, position: "relative" }}>
        {heroImg
          ? <img src={heroImg} alt="" style={{ width: "100%", height: "100%", objectFit: "cover" }}/>
          : <div style={{ width: "100%", height: "100%", background: "linear-gradient(135deg,#d0d0d0,#a8a8a8)", display: "flex", alignItems: "center", justifyContent: "center" }}>
              <span style={{ fontFamily: T.font, fontSize: 12, color: "#fff", opacity: 0.6 }}>Hero Image</span>
            </div>}
      </div>

      {/* ── Overlay card ── */}
      <div style={{ background: "#fff", borderRadius: 32, marginTop: -52, position: "relative", zIndex: 1, boxShadow: "0px 2px 4px rgba(0,0,0,0.1)", padding: "18px 15px 31px" }}>
        <div style={{ width: 328, margin: "0 auto", display: "flex", flexDirection: "column", gap: 32 }}>

          {/* ── Challenge Info: badge + title + description ── */}
          <div style={{ display: "flex", flexDirection: "column", gap: 32 }}>
            {/* Badge (80px square) */}
            <div style={{ width: 80, height: 80, flexShrink: 0 }}>
              {badgeImg
                ? <img src={badgeImg} alt="" style={{ width: 80, height: 80, objectFit: "contain" }}/>
                : <div style={{ width: 80, height: 80, background: "#E8E8E8", borderRadius: 8, display: "flex", alignItems: "center", justifyContent: "center" }}>
                    <span style={{ fontFamily: T.font, fontSize: 9, color: "#999" }}>Badge</span>
                  </div>}
            </div>
            {/* Title + subtitle */}
            <div style={{ display: "flex", flexDirection: "column", gap: 5 }}>
              ...
              <div style={{ fontFamily: T.font, fontSize: 15, fontWeight: 400, lineHeight: "20px", color: T.textSec }}>
                {goal || "Challenge goal description goes here"}
              </div>
            </div>
          </div>

          {/* ── Join CTA (full width, large, rounded) ── */}
          <button style={{ width: "100%", borderRadius: 12, background: T.orange, border: "none", fontFamily: T.font, fontSize: 16, fontWeight: 700, lineHeight: "21px", color: "#fff", cursor: "default", padding: "12px 24px" }}>
            Join the Challenge
          </button>
        </div>
        ...
        {/* ── Details Section ── */}
        <div style={{ width: 329, margin: "31px auto 0", display: "flex", flexDirection: "column", gap: 49 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
            ...
            <div style={{ background: "#fff", borderRadius: 16, padding: 16, boxShadow: "0px 2px 6px rgba(0,0,0,0.11)", display: "flex", gap: 12, alignItems: "center" }}>
              <div style={{ width: 48, height: 48, borderRadius: 8, background: "#E8E8E8", flexShrink: 0, overflow: "hidden", boxShadow: "0px 1.5px 3px rgba(0,0,0,0.1)" }}>
                {logoImg
                  ? <img src={logoImg} alt="" style={{ width: "100%", height: "100%", objectFit: "contain", borderRadius: 8 }}/>
                  : <span style={{ display: "flex", width: "100%", height: "100%", alignItems: "center", justifyContent: "center", fontFamily: T.font, fontSize: 9, color: "#999" }}>Logo</span>}
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                <div style={{ display: "flex", gap: 4, alignItems: "center", marginTop: 2 }}>
                  ...
                  <span style={{ fontFamily: T.font, fontSize: 13, color: T.textTer, lineHeight: "18px" }}>
                    {participants ? `${participants} Athletes` : "5,678 Athletes"}
                  </span>
                </div>
              </div>
...
Object.assign(window.MT, {
  ScreenNotJoined, ScreenChallengeDetails, ScreenJoined, ScreenCompleted, ScreenTakeover, ScreenMilestone, ScreenFollowerInFeed,
});
